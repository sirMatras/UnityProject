...
public class AxeDemon : BaseEnemy
{
    ...
    {
        SoundManager.instance.PlaySound2D("AxeDemonAttack");
    }

    public override void HitSound()
    {
        SoundManager.instance.PlaySound2D("AxeDemonHit");
    }

    public override void DeathSound()
    {
        SoundManager.instance.PlaySound2D("AxeDemonDeath");
    }
}
